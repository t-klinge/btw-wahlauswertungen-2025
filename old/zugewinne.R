...
wahlbezirke_zugewinne_btw1725_viz <- wahlbezirke_zugewinne_btw1725_vergleich |> 
  filter(!is.na(diff_2017_2025)) |> 
  mutate(diff_cat = case_when(between(diff_2017_2025, -Inf, -5) ~ "\u2264-5",
                              between(diff_2017_2025, -4.9, -2.5) ~ "-2,5 \u2013 -4,9",
                              between(diff_2017_2025, -2.4, 2.4) ~ "-2,4 \u2013 2,4",
                              between(diff_2017_2025, 2.5, 4.9) ~ "2,5 \u2013 4,9",
                              between(diff_2017_2025, 5, Inf) ~ "\u22655"),
         diff_cat = factor(diff_cat, levels = c("\u2264-5", "-2,5 \u2013 -4,9", "-2,4 \u2013 2,4", "2,5 \u2013 4,9", "\u22655"))) |> 
  ggplot() +
